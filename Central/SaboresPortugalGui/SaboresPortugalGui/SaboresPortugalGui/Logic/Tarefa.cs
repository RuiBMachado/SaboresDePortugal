...
namespace SaboresPortugalGui.Logic
{
    ...
    public class Tarefa 
    {
        ...
        public Tarefa(int id, String dataI, String dataF,String nome, float longitude, float latitude, String desc,
        ...
        public Tarefa(int id, float longitude, float latitude, string descricao, string localidade, string rua, string codPostal, int telefone, string email, String datai, String dataf)
        {
